...
endmult:    addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            sw      r6, r0, 0       #store result of mult into 0x0000
            addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            ...
            addi    r0, r0, 0       #nop
            addi    r0, r0, 0       #nop
            beq     r0, r0, end    #dummy test, since r0 == r0 WIll produce a micro loop but that is ok
...
stop:       addi    r0, r0, 0       #nop
            
            jalr    r7, r0          #jump to 0 (for jalr test purposes)
